...
class Ordinator {
    ...
    reset_obj_tmp = (objs) => {
        for (let index = 0; index < objs.length; index++) {
            if (objs[index].objtype != 'player' || (objs[index].objtype === 'player' && this.Tutorial.tutorialFinish)) {
                objs[index].collide = { collidesocial: false, colliderangea: false, collideself: false, collidealert: false };
